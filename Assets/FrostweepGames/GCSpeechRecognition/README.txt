...
VERSION 4.1.1 - FIXES OF COMMANDS EXAMPLE, GENERAL FIXES
VERSION 4.1.2 - UPDATED API OF GOOGLE SERVICE. UPDATED GENERAL TOOLS
VERSION 4.2 - CORE UPDATE. OPTIMIZATIONS. API UPDATE

-HOW TO RECEIVE AN API KEY
https://cloud.google.com/docs/authentication/api-keys#creating_an_api_key
https://www.youtube.com/watch?v=yit7yNGyVCE
