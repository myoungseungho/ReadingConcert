...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition.Examples
{
    public class GCSR_Example : MonoBehaviour
    {
        ...
        //이미지 색상 시점 설정
        public delegate void ImageChangeMoment();
        public static event ImageChangeMoment imagechangemoment;

        //이미지 색상 시점 설정
        public delegate void TextChangeMoment();
        public static event TextChangeMoment textchangemoment;
        ...
        private void InsertRecognitionResponseInfo(RecognitionResponse recognitionResponse)
        {
            ...
            {
                _resultText.text = "\n<color=red>단어가 감지되지 않았습니다.</color>";
                textchangemoment();
                return;
            }
